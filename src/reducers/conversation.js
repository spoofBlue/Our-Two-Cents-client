...
// Actions
import {
    DISPLAY_CONVERSATION_STARTED, DISPLAY_MESSAGE_LIST, UPDATE_CONVERSATION_DATA, UPDATE_HANDLER, DISPLAY_CONVERSATION_FINISHED,
    LEAVE_CONVERSATION, RESET_COMPONENT
...
export default function conversationReducer(state = initialState, action) {
    ...
    } else if (action.type === LEAVE_CONVERSATION) {
        return Object.assign({}, state, {
